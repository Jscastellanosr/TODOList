...
window.addEventListener('DOMContentLoaded', ()=>{
    ...
    if(JSON.parse(localStorage.getItem('projects'))){
        ...
        _createProject_js__WEBPACK_IMPORTED_MODULE_0__["default"].addTODO(defProj, 'wake up', (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(2023, 8, 21), 'PPP'), 'urgent', "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer venenatis est at ornare vulputate. Suspendisse consequat augue eu fringilla tincidunt. Donec hendrerit augue odio. Sed vitae nulla ultricies, imperdiet metus quis, porta nulla. Quisque varius, quam ut egestas euismod, augue eros pretium lectus, quis vulputate velit urna ut nisi. Quisque in arcu viverra, mattis orci sagittis, lacinia neque. Integer laoreet consequat velit a maximus. In porta placerat velit, ut sodales magna venenatis sed. Suspendisse potenti. In ut malesuada risus.")
        _createProject_js__WEBPACK_IMPORTED_MODULE_0__["default"].addTODO(defProj, 'breakfast', (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(2023, 9, 18), 'PPP'), 'urgent', 'xxx')
        _createProject_js__WEBPACK_IMPORTED_MODULE_0__["default"].addTODO(defProj, 'brush teeth', (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(2023, 5, 22), 'PPP'), 'urgent', 'xxx')
        _createProject_js__WEBPACK_IMPORTED_MODULE_0__["default"].addTODO(defProj, 'get dressed', (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(2023, 2, 31), 'PPP'), 'urgent', 'xxx')
...
todoForm.subm.addEventListener('click', () => {
    ...
    if(todoForm.title.value &&todoForm.date.value) {
        ...
        console.log((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(todoForm.date.value), 'PPP'))
        ...
        projectsArray.forEach(element => {
            if(element.name == todoList.id){
                _createProject_js__WEBPACK_IMPORTED_MODULE_0__["default"].addTODO(element, todoForm.title.value, (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(todoForm.date.value), 'PPP'), todoForm.priority.value, todoForm.description.value)
