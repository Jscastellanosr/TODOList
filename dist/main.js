...
class project {
    ...
    static addTODO (object, task, date, priority, description) {
        object.todos.push(new _createTodo_js__WEBPACK_IMPORTED_MODULE_0__["default"](task, date, priority, description))
        this.updateProjects(_index_js__WEBPACK_IMPORTED_MODULE_1__.projectsArray)
    ...
    static render(object) {
        ...
        editProj.addEventListener('click', () => {
            ...
            _index_js__WEBPACK_IMPORTED_MODULE_1__["default"].temp = object.name;
...
class TODO {
    ...
    static renderTodos (proj) {
        ...
        proj.todos.forEach(element => {
            ...
            checkbox.addEventListener('click', () => {
                ...
                proj.todos.forEach(todo => {
                    ...
                    if(todo.task == element.task) {
                        ...
                        _createProject_js__WEBPACK_IMPORTED_MODULE_1__["default"].updateProjects(_index_js__WEBPACK_IMPORTED_MODULE_0__.projectsArray)
                        console.log(_index_js__WEBPACK_IMPORTED_MODULE_0__.projectsArray)
                    }  
            ...
            date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(element.date), 'PPP')
            ...
            removeTodo.addEventListener('click', () => {
                _index_js__WEBPACK_IMPORTED_MODULE_0__["default"].temp = element.task
    ...
    static updateTodoInfo (task) {
            ...
            console.log(_index_js__WEBPACK_IMPORTED_MODULE_0__["default"].temp)
    ...
    static deleteTodo(todoName) {
        ...
        todoContainer.childNodes.forEach(tab => {
            ...
            if(tab.querySelector('#taskTitle').textContent == todoName){
                ...
                _index_js__WEBPACK_IMPORTED_MODULE_0__.projectsArray.forEach(proj => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ tempName),
...
warnWindow.querySelector('.yes').addEventListener('click', () => {
    ...
    if(warnWindow.querySelector('.yes').id == 'deleteProjectY'){
        ...
        _createTodo_js__WEBPACK_IMPORTED_MODULE_1__["default"].deleteTodo(tempName.temp)
        ...
        if(todoForm.querySelector('h2').textContent == "New TODO"){
            ...
            projectsArray.forEach(element => {
                ...
                if(element.name == todoList.id){
                    _createProject_js__WEBPACK_IMPORTED_MODULE_0__["default"].addTODO(element, todoForm.title.value, todoForm.date.value, todoForm.priority.value, todoForm.description.value)
                    _createTodo_js__WEBPACK_IMPORTED_MODULE_1__["default"].renderTodos(element)
                    todoFormWindow.classList.toggle('inactive')
                    return
                }
            })
                ...
                if(item.name == todoList.id) {
                    item.todos.forEach(task => {
                        ...
                        if(tempName.temp == task.task){
                            ...
                            _createTodo_js__WEBPACK_IMPORTED_MODULE_1__["default"].updateTodoInfo(task)
                            
                            todoFormWindow.classList.toggle('inactive')

                            _createTodo_js__WEBPACK_IMPORTED_MODULE_1__["default"].updateTodoTab(formerName, task);
